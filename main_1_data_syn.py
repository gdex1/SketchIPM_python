...
if __name__ == '__main__':
    ...
    plt.grid(True)
    plt.tight_layout()
    #plt.savefig('/home/ubuntu/ipm_figures/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_it_0.png', format='png', dpi=1200)
    plt.savefig(directory +'/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_1run_e'+str(power)+'_0.png', format='png', dpi=1200)
    f.clf()
    plt.close(f)
    ...
    plt.tight_layout()
    #plt.savefig('/home/ubuntu/ipm_figures/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_it_0.png', format='png', dpi=1200)
    plt.savefig(directory +'/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_1run_e'+str(power)+'_1.png', format='png', dpi=1200)
    f.clf()
    plt.close(f)
    ...
    plt.grid(True)
    plt.tight_layout()
    #plt.savefig('/home/ubuntu/ipm_figures/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_it_1.png', format='png', dpi=1200)
    plt.savefig(directory +'/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_1run_e'+str(power)+'_2.png', format='png', dpi=1200)
    f.clf()
    plt.close(f)
    ...
    plt.tight_layout()
    #plt.savefig('/home/ubuntu/ipm_figures/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_it_1.png', format='png', dpi=1200)
    plt.savefig(directory +'/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_1run_e'+str(power)+'_3.png', format='png', dpi=1200)
    f.clf()
    plt.close(f)
    ...
    plt.grid(True)
    plt.tight_layout()
    #plt.savefig('/home/ubuntu/ipm_figures/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_it_2.png', format='png', dpi=1200)
    plt.savefig(directory +'/svm_'+str(data_desc)+'_m'+str(m)+'_n'+str(n)+'_1run_e'+str(power)+'_4.png', format='png', dpi=1200)
    f.clf()
    plt.close(f)
